...
<link href="{{ URL::asset('assets/img/favicon.ico') }} ../assets/libs/prettify/github.css" rel="stylesheet" />
...
<link href="{{ URL::asset('assets/libs/summernote/summernote.css') }}" rel="stylesheet" type="text/css" />
