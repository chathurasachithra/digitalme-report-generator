...
<!-- Footer Start -->
<footer>
    Polygon3d &copy; <script>new Date().getFullYear()</script> powered by <a href="Gamma Test Technologies.com" target="_blank">Gamma Test Technologies</a>
    <div class="footer-links pull-right">
        <a href="#">Prices</a><a href="#">Help</a>
    </div>
</footer>
<!-- Footer End -->
</div>
