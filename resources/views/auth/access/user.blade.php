...
<div class="widget-content padding">
    ...
    <br/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="balance" value="{{ $user->balance }}" class="form-control" id="input-text"/>
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">Active From</label>
            <div class="col-sm-10">
                <input type="text" name="active_from" value="{{ $user->active_from }}" placeholder="Add Account Active Date" class="form-control" id="active_from"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="active_to" value="{{ $user->active_to }}" placeholder="Add Account Expire Date" class="form-control" id="active_to"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="col-sm-2" style="padding-left: 0px;">
                    <input type="file" name="profileimage" value="<?php echo ($user->profileimage != '')?$user->profileimage:'/media/profile/default_profile.jpg'; ?>" class="form-control" id="input-text"/>
                </div>
                <div class="profile-info">
                    <div class="col-xs-4">
                        <a href="#" class="rounded-image-settings profile-image-settings"><img src="<?php echo ($user->profileimage != '')?$user->profileimage:'/media/profile/default_profile.jpg'; ?>"></a>
                    </div>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="col-sm-2" style="padding-left: 0px;">
                    <input type="file" name="coverpic_image" value="<?php echo ($user->coverpic_image != '')?$user->coverpic_image:'/media/profile/default_cover_image.jpg'; ?>" class="form-control" id="input-text"/>
                </div>
                <div class="profile-info">
                  <div class="col-xs-4">
                     <a href="user/profile/settings" class="rounded-image-settings profile-image-settings"><img src="<?php echo ($user->coverpic_image != '')?$user->coverpic_image:'/media/profile/default_cover_image.jpg'; ?>"></a>
                  </div>
                </div>
            </div>
        </div>
...
@else
    ...
    <div class="widget">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Account Balance</label>
            <div class="col-sm-10">
                <input type="text" name="balance" value="" placeholder="Add Account Balance here" class="form-control" id="input-text"/>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Active From</label>
            <div class="col-sm-10">
                <input type="text" name="active_from" value="" placeholder="Add Account Active Date" class="form-control" id="active_from"/>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Active To</label>
            <div class="col-sm-10">
                <input type="text" name="active_to" value="" placeholder="Add Account Expire Date" class="form-control" id="active_to"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div class="profile-info">
                    <div class="col-xs-4">
                        <a href="#" class="rounded-image-settings profile-image-settings"><img src="<?php echo '/media/profile/default_profile.jpg'; ?>"></a>
                    </div>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div class="profile-info">
                  <div class="col-xs-4">
                     <a href="#" class="rounded-image-settings profile-image-settings"><img src="<?php echo '/media/profile/default_cover_image.jpg'; ?>"></a>
                  </div>
                </div>
            </div>
        </div>
